...
import school from '../Images/school@2x.png'
import bookshelf from '../Images/bookshelf@2x.png'
import asad from '../Images/asad.png'
import tayyab from '../Images/tayyab.png'
                                ...
                                <Grid item style={{paddingRight:'0px'}}>
                                    ...
                                    <input value={this.state.receiver_email} onChange={(e)=>{
                                            this.setState({receiver_email:e.target.value})
                                             ...
                                             style={{padding:'16px ',width:'300px',background: '#FFFFFF 0% 0% no-repeat padding-box',
                                boxShadow: '0px 9px 6px #00000029',
                                borderRadius: '3px',border:'1px solid white',outlineColor:'white'}} ></input>
                            ...
                            <Grid md={6} xs={12} className="text-center">
                                ...
                                <div>
                                    ...
                                    <Grid xs={6} item style={{paddingRight:'0px'}}>
                                        ...
                                        <input value={this.state.receiver_email} onChange={(e)=>{
                                            this.setState({receiver_email:e.target.value})
                                        }} style={{padding:'16px 10px 17px',width:'100%',background: '#FFFFFF 0% 0% no-repeat padding-box',
                                    boxShadow: '0px 9px 6px #00000029',
                                    borderRadius: '3px',border:'1px solid white',outlineColor:'white'}} ></input>
