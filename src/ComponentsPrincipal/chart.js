    ...
    render(){
        ...
        return(
            <div >
                ...
                <select style={{border:'1px solid #6437A1',color:'#6437A1'}} onChange={e=>{this.setState({selectedYear:e.target.value
